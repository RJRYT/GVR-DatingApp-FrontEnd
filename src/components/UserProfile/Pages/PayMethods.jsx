...
const PayMethods = () => {
  return (
    <>
      <div className="relative bg-white rounded-t-3xl min-h-screen p-6 mt-4">
        ...
        <h1 className="mt-10 text-fuchsia-900 text-2xl font-medium text-center w-full max-w-screen mx-auto pt-3 pb-4 tracking-wide">
          Payments methods
        </h1>
        <p className="text-left text-xs font-semibold ml-3 mr-1">
          choose desired payment type.We offer easy ways
          <br /> for payments on our app
        </p>
        <div className="mt-4 mx-3 p-4 border border-red-600 rounded-md flex items-center justify-between">
          <img
            src={MasterCard}
            className="w-[25%] mr-4"
            alt="MasterCard Logo"
        ...
        <div className="mt-4 mx-3 p-4 border border-gray-350 rounded-md flex items-center justify-between shadow-md">
          <img
            src={VISA}
            className="w-[25%] mr-4 bg-transparent"
            alt="VISA Logo"
          />
          <div className="text-left">
            <h4 className="text-black font-medium text-lg mb-1">
        ...
        <div className="mt-4 mx-3 p-4 border border-gray-350 rounded-md flex items-center justify-between shadow-md">
          <img
            src={PetraStark}
            className="w-[25%] h-[16%] mr-4 bg-transparent ml-4"
            alt="P logo"
          />
          <div className="text-left">
        ...
        <h3 className="transform uppercase font-medium ml-3 mt-10">
          Current Method
        </h3>

        <div className="mt-4 mx-3 p-4 border border-gray-350 rounded-md flex items-center justify-between relative shadow-md">
          <img
            src={dollar}
            className="w-[18%] h-[13%] mr-10 bg-transparent "
            alt="dollar Logo"
          />
          <div className="text-left">
        ...
        <div className="px-8">
          <Link
            ...
            className="bg-fuchsia-950 w-full mt-16 mb-2 py-2 rounded-lg text-white text-md  transform uppercase"
          >
            Add Payment Method
          </Link>
        </div>
