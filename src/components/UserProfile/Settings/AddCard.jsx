...
const AddCard = () => {
  return (
    <div className="items-center justify-center min-h-screen bg-white">
      ...
      <div className="text-3xl text-fuchsia-950 px-8 font-bold ">
        Add Credit Card
      </div>
      ...
      <div className="px-8 pt-8 ">
        ...
        <div className=" pt-2 border-b border-black">
          <input
            placeholder=""
            className="focus:outline-none bg-transparent text-medium "
          />
        </div>
      </div>
      <div className="px-8 pt-8 ">
        <button className="bg-fuchsia-950 rounded-lg text-white px-10 py-2 flex items-center">
          <RiQrScan2Line className="text-white mr-2" />
          Scan card
        </button>
      </div>
      <div className="flex flex-col sm:flex-row px-8 pt-8">
        <div className="w-full sm:w-auto">
          ...
          <div className="pt-2 border-b border-black">
            <input
              placeholder=""
              className="w-full focus:outline-none bg-transparent text-medium"
            />
          </div>
        </div>
      ...
      <div className="px-8 pt-16">
        <p className="font-light">
          Debit cards are accepted a same locations and for same categories
        </p>
      </div>
      <div className="flex justify-center space-x-4 mt-8">
        <img
          src={visa}
          alt="Visa"
          className="w-16 aspect-[3/2] object-contain"
        />
        <img
          src={mastercard}
          alt="Mastercard"
      ...
      <div className="text-center">
        <button className="bg-fuchsia-950 w-2/3 mt-16 mb-2 py-2 rounded-lg text-white text-xl font-bold">
          Add Payment Method
        </button>
      </div>
    </div>
