...
const ChangePassword =()=>{
    return(
        ...
        <h3 className="flex-1 text-center text-white text-2xl font-semibold text-lg">Change Password</h3>
      </div>
      <div className="bg-white rounded-t-3xl min-h-screen p-6 h-96 mt-4 font-sans">
        <div  className='p-6'>
        <p className='font-sm text-medium border-b pb-4'>Feeling worried about your account been easily preyed on? Then change that password now!</p>
        </div>
        ...
        <div className='text-center'>
          <button className='bg-fuchsia-950 text-white rounded-full py-4 px-24 mt-48 '>Update</button>
        </div>
      </div>
        </div>
    )
