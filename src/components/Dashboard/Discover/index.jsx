...
import CountryDropdown from './CountryDropdown'; // Make sure this path is correct based on your project structure
            ...
            <div className="flex space-x-4">
                <button className="text-purple-500">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="23.7664" cy="23.7669" r="8.98856" stroke="#4B164C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M30.0181 30.4854L33.5421 34.0002" stroke="#4B164C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </button>
                <button className="text-purple-500">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
